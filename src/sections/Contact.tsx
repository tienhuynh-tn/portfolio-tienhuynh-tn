  ...
  return (
      <Section id="contact" className="pb-0">
        <div className="reveal" ref={revealRef}>
          {/* 1) Title: light = dark blue, dark = cyan (theme primary) */}
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <h3 className="text-2xl font-bold text-[color:var(--text)]">Let’s work together</h3>
                <p className="mt-3 max-w-xl leading-relaxed text-[color:var(--muted)]">
                  I’d love to learn about your goals and see how I can help turn ideas into reliable,
                  well-crafted products. Whether you’re planning a new build, refining an existing
                  system, or just exploring options, feel free to reach out.
                </p>
              </div>

              {/* 4) Icons: light has subtle bg, dark has no bg */}
              <div className="flex flex-col gap-4">
                ...
                <span className="mt-0.5 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[color:var(--border)] bg-slate-100 text-[color:var(--primary)] dark:bg-transparent">
                  <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden="true">
                    {/* Mail icon with correct “bottom leg” */}
                    <path
                        d="M4 6h16a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2zm0 2l8 5 8-5H4zm16 12V9l-8 5-8-5v11h16z"
                        fill="currentColor"
                    />
                  </svg>
                </span>
            ...
            <form
                ...
                /* 3) Form: no filled background in both modes, border only */
            ...
            >
              ...
              >
                ...
                <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                  <path d="M3 11.5l17-7-6.5 17-2.5-6-6-4z" fill="currentColor" />
                </svg>
              </button>
          ...
          <div className="mt-10 border-t border-[color:var(--border)] pt-6">
            {/* 5) Footer icons: modern + consistent theme, no heavy bg */}
            ...
            <div className="mt-3 text-center text-sm text-[color:var(--muted)]">
              © 2026 Tien Huynh (Fairy). Built with 💚 using React, TypeScript, Tailwind CSS, and
              late-night learning + milk tea.
              <br />
